...
internal static class Constants
{
	...
	public const float TIME_FADEOUT_TEXT = 1000f;

	public const uint TIME_DISPLAY_SYSTEM_MESSAGE_TEXT = 10000u;
	...
	public const int MAX_LAND_DATA_INDEX_COUNT = 16384;

	public const int MAX_STATIC_DATA_INDEX_COUNT = 81920;

	public const int MAX_LAND_TEXTURES_DATA_INDEX_COUNT = 16384;

	public const int MAX_GUMP_DATA_INDEX_COUNT = 65536;

	public const int MAX_SOUND_DATA_INDEX_COUNT = 65535;

	public const int MAX_MULTI_DATA_INDEX_COUNT = 8704;

	public const int MAX_MUSIC_DATA_INDEX_COUNT = 150;

	public const int MAX_ANIMATIONS_DATA_INDEX_COUNT = 4096;

	public const int MAX_ANIMATIONS_DATA_INDEX_COUNT_MUL = 1050;

	public const int MAX_LIGHTS_DATA_INDEX_COUNT = 500;

	public const ushort FIELD_REPLACE_GRAPHIC = 6182;

	public const ushort TREE_REPLACE_GRAPHIC = 3673;
	...
	public const int MAX_VIEW_RANGE = 31;

	public const int MAX_CONTAINER_OPENED_ON_GROUND_RANGE = 3;

	public const int OUT_RANGE_COLOR = 907;

	public const int DEAD_RANGE_COLOR = 910;

	public const int DEATH_SCREEN_TIMER = 1500;

	public const float SOUND_DELTA = 250f;

	public const ushort HIGHLIGHT_CURRENT_OBJECT_HUE = 20;
	...
	public const int WEATHER_TIMER = 360000;

	public const int PREDICTABLE_CHUNKS = 300;

	public const int PREDICTABLE_TILE_COUNT = 19200;

	public const int PREDICTABLE_STATICS = 38400;

	public const int PREDICTABLE_MULTIS = 76800;

	public static int MAPS_COUNT = 2;

	public static readonly bool[] BAD_CONTAINER_LAYERS = new bool[30]
	{
