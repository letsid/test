...
internal class CustomHouseMisc : CustomHouseObject
{
	...
	public override bool Parse(string text)
	{
		...
		if (array.Length >= 11)
		{
			flag = int.TryParse(array[0], out Category) && int.TryParse(array[1], out Style) && int.TryParse(array[2], out TID) && int.TryParse(array[3], out Piece1) && int.TryParse(array[4], out Piece2) && int.TryParse(array[5], out Piece3) && int.TryParse(array[6], out Piece4) && int.TryParse(array[7], out Piece5) && int.TryParse(array[8], out Piece6) && int.TryParse(array[9], out Piece7) && int.TryParse(array[10], out Piece8) && int.TryParse(array[11], out FeatureMask);
		}
		if (flag)
		{
